...
print("\nthe path between two nodes is :" , find_path(graph ,'A','B'))
...
print("\nthe path between two nodes is :" , find_all_path(graph ,'A','B'))
...
print("\nadd an edge : ", add_edge(graph, {"A","K"}))
print("\nNew graph: ",graph)
